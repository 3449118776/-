...
AI 写作有两大通病：**记不住（吃书）**和**想偷懒（敷衍）**。

质量保障体系就是给 AI 戴上的"紧箍咒"——动笔前先检查，写完了再打分，不过关不许交付。
...
| 红线 | 触发条件 | 处理 |
|------|---------|------|
| **吃书红线** | 一致性评分低于 12/20 | 不管其他分多高，直接打回重写 |
| **水字数红线** | 信息量评分低于 12/20 | 不管其他分多高，直接打回重写 |
| **AI 味红线** | AI病检测低于 9/15 | 不管其他分多高，直接打回重写 |
